...
class KfacOptimizer:
    ...
    def apply_gradients_kfac(self, grads):
        ...
        if self._async_eigen_decomp:
            ...
            enqueue_op = tf.cond(
                pred=tf.logical_and(tf.equal(tf.math.mod(self.stats_step, self._kfac_update), tf.convert_to_tensor(
        ...
        with tf.control_dependencies([global_step_op]):
            ...
            with tf.control_dependencies(dependency_list):
                ...
                if not self._async_eigen_decomp:
                    ...
                    update_factor_ops = tf.cond(pred=tf.logical_and(tf.equal(tf.math.mod(self.stats_step, self._kfac_update),
